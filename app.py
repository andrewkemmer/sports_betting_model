...
st.title("📈 Sports Betting EV Model with ML Retraining")
    ...
    if not api_key:
        ...
        if df is not None:
            ...
            for (gid, book), g in grouped:
                ...
                results.append({"team": t1.team, "odds": t1.price, "no_vig_prob": nv1, "EV": ev1})
                results.append({"team": t2.team, "odds": t2.price, "no_vig_prob": nv2, "EV": ev2})
